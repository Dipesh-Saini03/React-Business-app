    ...
    <section id="about">
        <div class="container">
            <div className="title_headling">
                ...
                <p>We believe the best ideas come from collaboration. Partner with us, and let's create something extraordinary together.</p>
            </div>
            <div className="about_box_wrapper">
                <div className="about_box">
                    ...
                    <div className="about_content">
                        <h5>Development</h5>
                        <p> "Fueling Progress, Driving Success: Your Business, Our Expertise!"
                ...
                <div className="about_box">
                    ...
                    <div className="about_content">
                        <h5>Integration</h5>
                        <p>"Seamless Integration, Unified Success: our Business, Our Expert Harmony!"</p>
                    </div>
                </div>
                <div className="about_box">
                    ...
                    <div className="about_content">
                        <h5>Branding</h5>
                        <p>"Crafting Brands, Inspiring Legacies: Your Business, Our Art of Identity!"
            ...
            <div className="about_box_details">
                <div className="about_col">
                    ...
                    <div className="img_info__box">
                        ...
                        <p>Unlock Savings Now! Get Your Price Quote Today<br/> - Fast, Easy, and Hassle-Free.</p>
                        <a href="/">{faPhoneIcon} <span>+91-7850985582</span></a>
                    </div>
                </div>
                <div className="about_col more_space">
                    <h3>We have business skills that will increase your earnings</h3>
                    <p>Unlocking Profit Potential with Expertise, Your Success is Our Promise and Maximize Your Bottom Line: Where Business Skills Meet Revenue Growth.</p>

                    <div className="grid_info">
                        <div className="icon">{faUserClockIcon}</div>
                        <div className="detail">
                            <h4>Start your own business in minutes</h4>
                            <p>From Idea to Enterprise: Launch Your Own Business in Minutes.</p>
                        </div>
                    </div>
                    <div className="grid_info">
                        ...
                        <div className="detail">
                            ...
                            <p>Seamless Solutions, Swift Success: Open Your Business Account Online Today.</p>
                        </div>
                    </div>
                </div>
            </div>
